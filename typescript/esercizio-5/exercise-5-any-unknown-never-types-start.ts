...
let currency: any = { name: "Indian rupee" } /* as any */; /* Jeremy, posso usare il type assertion in questo caso? Cioè provando funziona, ma volevo sapere se è corretto usarlo.  */
